...
## Fuentes de contenido — Loop 4, Lectura de Señales (2026-09-15)

Investigadas para el mapa enciclopédico de conocimiento de la entrada `lectura-de-senales`. Ver detalle completo en `60_LOOP_04_LECTURA_DE_SENALES.md`. No modifican código ni contenido editorial final; son fuentes del mapa de investigación.

| Fuente | URL | Tipo | Respalda | Estado |
|---|---|---|---|---|
Llewellyn, D.; Golem, S.; Jones, A.M.P.; Zheng, Y. (2023) — "Foliar Symptomology, Nutrient Content, Yield, and Secondary Metabolite Variability of Cannabis Grown Hydroponically with Different Single-Element Nutrient Deficiencies", *Plants* (MDPI) 12(3):422 | https://pmc.ncbi.nlm.nih.gov/articles/PMC9920212/ | SCIENTIFIC | Síntomas visuales de deficiencias individuales N/P/K/Ca/Mg/S/Fe/Mn en Cannabis tipo droga (cv. Gelato 29), fase reproductiva; senescencia natural confundible con deficiencias; evidencia de que síntomas visuales no siempre coinciden con análisis foliar; enfoque integrado recomendado | VERIFIED — texto completo leído directamente (acceso abierto CC BY) |
| Punja, Z.K. et al. (2019) — "Pathogens and Molds Affecting Production and Quality of *Cannabis sativa* L.", *Front. Plant Sci.* 10:1120 | https://www.frontiersin.org/journals/plant-science/articles/10.3389/fpls.2019.01120/full | SCIENTIFIC | Patógenos radicales (Fusarium oxysporum/solani, Pythium spp.), foliares (oídio, Botrytis cinerea en buds y hojas), hongos en inflorescencias (Penicillium, Fusarium bud rot); síntomas aéreos producidos por patógenos radicales indistinguibles de estrés hídrico/nutricional | VERIFIED — texto completo leído directamente (acceso abierto CC BY) |
| Righetti, L. et al. (2018) — "Not the one, but the only one: about Cannabis cryptic virus in plants showing 'hemp streak' disease symptoms", *Eur. J. Plant Pathol.* 150:575–588 | https://link.springer.com/article/10.1007/s10658-017-1301-y | SCIENTIFIC | Clorosis intervenal + enrollamiento de márgenes como síntoma frecuente en Cannabis sin causa viral demostrada; CanCV presente en plantas sintomáticas y asintomáticas sin correlación causal; HSV no demostrado; estrés abiótico señalado como posible factor | PARTIAL — abstract y metadatos confirmados por lectura directa de la página Springer; texto completo bloqueado (paywall) |
| Pulkoski, M.; Burrack, H. (2024) — "Assessing the impact of piercing-sucking pests on greenhouse-grown industrial hemp (*Cannabis sativa* L.)", *Environ. Entomol.* 53(1):1–10 | https://pmc.ncbi.nlm.nih.gov/articles/PMC10878361/ | SCIENTIFIC | Araña roja (*Tetranychus urticae*): cupping y amarillamiento de hojas; efecto sobre cannabinoides dependiente de densidad y tiempo; contradicción con estudio israelí documentada | VERIFIED — texto completo leído directamente (acceso abierto CC BY) |
| LCV en Cannabis — Viruses 2019, 11(9):802 | https://www.mdpi.com/1999-4915/11/9/802 | SCIENTIFIC | Lettuce Chlorosis Virus (crinivirus) produce clorosis intervenal en Cannabis indistinguible de deficiencias nutricionales | PARTIAL — abstract confirmado por snippet y múltiples fuentes secundarias; texto completo bloqueado (HTTP 403 al intentar lectura directa) |

## Fuentes de contenido — Loop 5, Cultivo en Secuencia (2026-09-15)

Investigadas para el mapa enciclopédico de conocimiento de la entrada `cultivo-en-secuencia`. Ver detalle completo en `61_LOOP_05_CULTIVO_EN_SECUENCIA.md`. No modifican código ni contenido editorial final. Se listan solo las fuentes NUEVAS de este loop — Hesami 2023, Alter 2024, Zhang 2021, Ahrens 2023 y Llewellyn/Golem/Jones/Zheng 2023 ya estaban registradas (ver `sources.js` y secciones anteriores de este documento) y se reutilizaron sin re-verificación.

| Fuente | URL | Tipo | Respalda | Estado |
|---|---|---|---|---|
| Toth, J.A.; Stack, G.M.; Carlson, C.H.; Smart, L.B. (2022) — "Identification and mapping of major-effect flowering time loci Autoflower1 and Early1 in Cannabis sativa L.", *Front. Plant Sci.* 13:991680 | https://www.frontiersin.org/journals/plant-science/articles/10.3389/fpls.2022.991680/full | SCIENTIFIC | Locus Autoflower1 (cromosoma 1, recesivo, mendeliano simple) y locus Early1 (floración temprana); evidencia de un tercer mecanismo genético no identificado en germoplasma de grano canadiense insensible al fotoperiodo sin marcadores de Autoflower1 | VERIFIED — texto completo leído directamente (acceso abierto) |
| Dowling, C.A.; Shi, J.; Toth, J.A.; Quade, M.A.; Smart, L.B.; McCabe, P.F.; Schilling, S.; Melzer, R. (2024) — "A FLOWERING LOCUS T ortholog is associated with photoperiod-insensitive flowering in hemp (Cannabis sativa L.)", *The Plant Journal* | https://onlinelibrary.wiley.com/doi/10.1111/tpj.16769 | SCIENTIFIC | Locus Autoflower2 con ortólogo CsFT1 de FLOWERING LOCUS T; concluye "al menos dos mecanismos genéticos independientes" de insensibilidad al fotoperiodo en C. sativa | VERIFIED — título, autoría completa y resumen verificados por lectura directa vía Europe PMC; texto completo bloqueado (paywall Wiley) |
| Divashuk, M.G.; Alexandrov, O.S.; Razumova, O.V.; Kirov, I.V.; Karlov, G.I. (2014) — "Molecular Cytogenetic Characterization of the Dioecious Cannabis sativa with an XY Chromosome Sex Determination System", *PLoS ONE* 9(1):e85118 | https://pmc.ncbi.nlm.nih.gov/articles/PMC3897423/ | SCIENTIFIC | Sistema cromosómico XY de determinación sexual en Cannabis sativa (machos XY, hembras XX), región pseudoautosómica en el cromosoma Y | VERIFIED — texto completo leído directamente (acceso abierto) |
| Fernández Torne, F.; Bosco, T.; Idaszkin, Y.L.; Bigatti, G.; Garcés, N.; Lozada, M.; González-José, R.; Márquez, F. (2023) — "The shape of Cannabis sativa L. seeds for the differentiation of commercial medicinal cultivars from Argentina", bioRxiv (preprint) | https://www.biorxiv.org/content/10.1101/2023.08.07.552192.full.pdf | SCIENTIFIC (preprint) | Morfometría geométrica de semilla distingue los cultivares argentinos Malvina (pequeña, redondeada) y Pachamama (grande, ovalada) con >97% de asignación correcta — variabilidad genética argentina detectable ya en la semilla | PARTIAL — preprint sin revisión por pares confirmada; título, autoría y resumen verificados por lectura directa |
| Mieja Andrada, C.N.; Olmos, M.G.; Garcia, J.M.; Alegre Porto, M.; Zalazar, N.O.; Zerrizuela, S.C.; Erazzu, L.E.; Martinez Calsina, L.; Fontana, P.D. (2025) — "Cáñamo Industrial en Tucumán: Primeros Avances de la Red de Ensayos del INTA" | https://repositorio.inta.gob.ar/xmlui/handle/20.500.12123/22261 | OFFICIAL (póster institucional) | Evaluación en curso de fenología y productividad de biomasa de genotipos de cáñamo introducidos de Europa y Asia, EEA Famaillá, Tucumán — evidencia argentina más directa de investigación fenológica de Cannabis en curso, pero sin datos numéricos accesibles | PARTIAL — solo metadatos y resumen verificados; contenido fenológico completo no accesible en esta sesión |
| Gobierno argentino / INTA Alto Valle, INTA Bariloche, Asociación Civil Ciencia Sativa — "Cosecharon las primeras plantas de cannabis en el INTA Alto Valle" | https://www.argentina.gob.ar/noticias/cosecharon-las-primeras-plantas-de-cannabis-en-el-inta-alto-valle | OFFICIAL | Cultivo real de dos variedades seleccionadas en INTA Bariloche, 850 plantas bajo macrotúneles en Neuquén, proyecto iniciado en 2019, primera cosecha; sin datos fenológicos medidos publicados | VERIFIED — comunicado oficial leído directamente; es evidencia de cultivo real, no de fenología medida |
